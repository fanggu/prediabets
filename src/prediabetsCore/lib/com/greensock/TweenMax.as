...
//---- STATIC FUNCTIONS -----------------------------------------------------------------------------------------------------------
		 ...
		 */
		public static function pauseAll(tweens:Boolean=true, delayedCalls:Boolean=true, ignoreCanBePaused:Boolean = false):void {
			changePause(true, tweens, delayedCalls,ignoreCanBePaused);
		}
		 ...
		 */
		private static function changePause(pause:Boolean, tweens:Boolean=true, delayedCalls:Boolean=false, ignoreCanBePaused:Boolean = false):void {
			var a:Array = getAllTweens();
			var isDC:Boolean; //is delayedCall 
			var i:int = a.length;
			while (i--) {
				...
				if (isDC == delayedCalls || isDC != tweens) {
					if(TweenCore(a[i]).vars && ((TweenCore(a[i]).vars["canBePaused"] != null && TweenCore(a[i]).vars["canBePaused"] == true) || ignoreCanBePaused ) ){
