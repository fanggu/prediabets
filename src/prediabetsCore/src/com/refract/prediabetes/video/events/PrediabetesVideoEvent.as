package com.refract.prediabetes.video.events {
	import flash.events.Event;
	


	public class PrediabetesVideoEvent extends Event {
		...
		public function PrediabetesVideoEvent(type : String, url:String, bubbles : Boolean = false, cancelable : Boolean = false) {
