package com.refract.prediabets.components.feedback {
...
//			_submit = new LSButton("page_feedback_submit",{fontSize:36},btnWidth,70,true,false);
	...
	//		page_feedback_thanks
		...
		protected function onShowThanks():void{
			...
			_submit.minW = 270;
			_submit.addEventListener(MouseEvent.CLICK,onClose);
		...
		protected function onClose(evt:MouseEvent = null):void{
			_submit.removeEventListener(MouseEvent.CLICK,onClose);
