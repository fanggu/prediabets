package com.refract.prediabets.components.nav {
	...
	import com.refract.prediabets.components.nav.footer.FullScreenButton;
	import com.refract.prediabets.components.nav.footer.PlayPauseButton;
	import com.refract.prediabets.components.nav.footer.SoundButton;
...
//					evt.info.button.scaleY = 40;
		...
		//	lsButton.x = 20;
			...
			_footerButtons[AppSections.MEDICAL_QUESTIONS] = lsButton;
			lsButton.addEventListener(MouseEvent.CLICK, footerButtonClick);
			lastButton = lsButton;
			...
			_footerButtons[AppSections.EMERGENCY_INFO] = lsButton;
			lsButton.addEventListener(MouseEvent.CLICK, footerButtonClick);
			lastButton = lsButton;
		...
		//	lsButton.x = - 90; // - lsButton.width;
			...
			*/
			...
			if(AppSettings.DEVICE != AppSettings.DEVICE_PC){
				...
				lsButton.y = _buttonY;
				lsButton.id = AppSections.GET_THE_APP;
			...
			_footerButtons[AppSections.ABOUT] = lsButton;
			lsButton.addEventListener(MouseEvent.CLICK, footerButtonClick);
			lastButton = lsButton;
			...
			_footerButtons[AppSections.CREDITS] = lsButton;
			lsButton.addEventListener(MouseEvent.CLICK, footerButtonClick);
			lastButton = lsButton;
