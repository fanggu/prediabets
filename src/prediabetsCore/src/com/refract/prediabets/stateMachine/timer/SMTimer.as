package com.refract.prediabets.stateMachine.timer {
	import com.refract.prediabets.stateMachine.view.interactions.Interaction;
		...
		public function SMTimer(delay : Number, repeatCount : int = 0) 
		{
		 ...
		 private function onTimerInterval(e:TimerEvent):void 
                ...
                */
				...
				{
					var thisTime : Number = getTimer() - _lastTime + _totLastTime;
					return thisTime ; 
				}
	}
}
